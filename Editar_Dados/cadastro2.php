...
<div class="row container">
  <p>&nbsp;</p>
  <form action="banco_de_dados/create2.php" method="post" class="col s12">
    <fieldset class="formulario" style="padding: 15px">
      <legend><img src="imagens/boneco_aliquota.jpeg" alt="[imagem]" width="100"></legend>
      <h5 class="light center">Cadastro 2</h5>
      ...
      <!--CAMPO CONTA-->
      <div class="input-field col s12">
        <input placeholder="Conta" type="number" name="conta" id="conta" maxlength="6" required autofocus>
