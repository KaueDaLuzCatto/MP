...
$querySelect = $link->query("SELECT codigo_municipio, data_vigencia, codigo_servico FROM tb_aliquotas");
$array_servicos = [];
...
foreach($array_servicos as $servico) {
    if($servico['codigo_municipio'] == $codigo_municipio && $servico['data_vigencia'] == $data_vigencia && $servico['codigo_servico'] == $codigo_servico) {
...
$queryInsert = $link->query("INSERT INTO tb_aliquotas (codigo_municipio, data_vigencia, codigo_servico, descricao_aliquota, percentual_aliquota, data_manutencao, hora_manutencao, usuario_manutencao) VALUES ('$codigo_municipio','$data_vigencia','$codigo_servico','$descricao_aliquota','$percentual_aliquota','$data_manutencao','$hora_manutencao','$usuario_manutencao')");
